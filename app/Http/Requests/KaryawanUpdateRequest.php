...
class KaryawanUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'email'             => ['required', 'email', new HTMLTag, 'unique:account,email,'. $this->id],
            'phone'             => ['required', 'unique:account,phone,' . $this->id, 'max:20'],
            ...
            'ktp_number'        => ['required', 'digits:16', 'unique:identity,ktp_number,' . $this->id],
        ];
    }
